...
const {total_sales,total_user,total_seller,total_admin,total_spent_by_category,top_5_spender,monthly_sales,
    show_users,edit_user,delete_user,show_sellers,edit_seller,delete_seller,show_coupons,edit_coupon,delete_coupon,create_coupon,show_payment} = require('../controllers/admin')
// before
